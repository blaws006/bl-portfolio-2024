  ...
  return (
    <div className='bg-zinc-950 text-center sm:columns-3 py-2'>
        ...
        <nav className='columns-3 py-2'>
            <div className='text-white'><Link to='/'>About</Link></div>
            <div className='text-white'><Link to='/portfolio'>Portfolio</Link></div>
            <div className='text-white'><Link to='/contact'>Contact</Link></div>
        </nav>
